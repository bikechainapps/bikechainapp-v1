    ...
    request.onload = function () {
        ...
        for (var i = 0; i < numberOfUsers; i++) {
            if (typeof gTextSent[i] != "undefined") {
                ...
                var row = body.insertRow(i);
                row.innerHTML = "<td><input type='checkbox' class='selectBoxes' onchange='checkmarkChangeForSwap(this)'> <custom>(" + (i + 1) + ")</custom></td><td>" + table[i][2] + "</td><td>" + table[i][3] + "</td><td>" + table[i][1] + '</td><td id="centerData"><button type="button" class="btn btn-danger btn-lg" onclick="Delete(this)">Cancel Turn</button></td>';
            }
        }
